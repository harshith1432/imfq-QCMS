...
const PlatformSettings = {
    ...
    renderFeatures(features) {
        ...
        features.forEach((f, i) => {
            ...
            div.className = 'd-flex gap-2 align-items-center bg-light p-2 rounded feature-item';
            div.innerHTML = `
    ...
    renderSteps(steps) {
        ...
        steps.forEach((s, i) => {
            const div = document.createElement('div');
            div.className = 'd-flex gap-2 align-items-center bg-light p-2 rounded step-item';
            div.innerHTML = `
                <div class="row g-2 flex-grow-1">
                    <div class="col-md-2">
    ...
    renderPricingPlans(plans) {
        ...
        plans.forEach((p, i) => {
            const div = document.createElement('div');
            div.className = 'bg-light p-3 rounded border pricing-item mb-2';
            div.innerHTML = `
    ...
    renderFAQs(faqs) {
        ...
        faqs.forEach(f => {
            const div = document.createElement('div');
            div.className = 'd-flex gap-2 align-items-start bg-light p-2 rounded';
            div.innerHTML = `
