...
def main():
    ...
    template_path = r'd:\projects softwares\imfq\backend\app\utils\QC_Story_Closure_Summary_Template.pdf'
    if not os.path.exists(template_path):
        print(f"Template path '{template_path}' does not exist. Skipping.")
        return
