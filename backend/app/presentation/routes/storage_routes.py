...
# Function: get_signed_download_url (Lines 16-93)
# Reason: S3/GCS signed URL generator (QCMS serves uploads directly via /uploads/<filename>).
# ==============================================================================
...
#         "auth_status": reason
#     }), 200
# [END DEAD CODE: get_signed_download_url]
...
# ==============================================================================
# [DEAD CODE - UNUSED BY FRONTEND / REMOVED FEATURE]
# Function: secure_delete_file (Lines 135-176)
# Reason: Storage deletion route.
# ==============================================================================
...
# [END DEAD CODE: secure_delete_file]



# ==============================================================================
# [DEAD CODE - UNUSED BY FRONTEND / REMOVED FEATURE]
# Function: get_storage_info (Lines 179-183)
# Reason: Redundant storage info route.
# ==============================================================================
...
# [END DEAD CODE: get_storage_info]
